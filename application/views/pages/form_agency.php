                ...
                <div class="container-xl d-flex flex-column justify-content-center">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <?php endif;?>
                            <form action="<?= base_url()?>form/add_agency" enctype="multipart/form-data" method="POST" id="formMarketing">
                                <input type="hidden" name="id" class="form" value="<?= $id?>">
                                <div id="form-1">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="" class="form-control" value="<?= $nama_batch?>" readonly>
                                        <label>Batch</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" name="tgl_akad" class="form-control" value="<?= $tgl_batch?>" readonly>
                                        <label>Tgl Akad</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama_agency" class="form form-control form-1">
                                        <label>Nama Agency</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" name="nama_pemilik" class="form form-control form-1">
                                    ...
                                    <div class="form-group mb-3">
                                        <label>
                                            <span class="mb-2">Upload Foto Bukti Pembayaran</span>
                                            <input type="file" name="file[]" class="form-control form-1 upload-gambar">
                                        </label>
                                    </div>
                                ...
                                <div id="form-2" style="display:none">
                                    ...
                                    <div class="form-group mb-3">
                                        <label>
                                            <span class="mb-2">Upload Foto KTP</span>
                                            <input type="file" name="file[]" class="form-control form-2 upload-gambar">
                                        </label>
                                    </div>
                                ...
                                <div id="form-4" style="display: none">
                                    <?php $this->load->view("pages/akad/agency_form");?>
...
<script>
    $(".upload-gambar").change(function () {
        ...
        if ($.inArray($(this).val().split('.').pop().toLowerCase(), fileExtension) == -1) {
            ...
            Swal.fire({
                icon: "error",
                title: "Oops...",
                text: "Format yang dibolehkan : "+fileExtension.join(', '),
            })
    ...
    $("#form-1 .btnNext, #form-3 .btnBack").click(function(){
        ...
        if(eror == 1){
            ...
            let result = ajax(url_base+`form/check_data_agency`, "POST", data);
            if(result){
                Swal.fire({
                    icon: "error",
                    title: "Oops...",
