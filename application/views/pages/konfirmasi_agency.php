                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <table id="dataTable" class="table card-table table-vcenter text-dark">
                                <thead>
                                    <tr>
                                        <th class="text-dark desktop mobile-p mobile-l tablet-p tablet-l" style="font-size: 11px">Nama Agency</th>
                                        <th class="text-dark desktop" style="font-size: 11px">Nama Pemilik</th>
                                        <th class="text-dark w-1 desktop" style="font-size: 11px">Batch</th>
