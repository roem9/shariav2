                            ...
                            <table id="dataTable" class="table card-table table-vcenter text-dark">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-dark desktop mobile-l mobile-p tablet-l tablet-p" style="font-size: 11px">Nama LAC</th>
                                        ...
                                        <th class="text-dark desktop w-1" style="font-size: 11px">Total Marketing</th>
