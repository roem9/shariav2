...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <p class="center bold"><span style="font-size: 14px"><u>KONTRAK PERJANJIAN PT SHARIA GRUP INDONESIA <br> DENGAN AGEN PERSONAL</u></span></p>
    <p class="center"><i>Bismillahirrahmanirrahim</i></p>
    <p>Pada hari ini <?= $hari?> <?= $tgl?> di Bogor yang bertanda tangan di bawah ini :</p>
    ...
    <p>Dalam hal ini bertindak untuk dan atas nama <b>(AGENCY PROPERTY PT SHARIA GRUP INDONESIA)</b> yang selanjutnya disebut sebagai <b>PIHAK PERTAMA</b>.</p>
    <table style="width:100%; padding: 0px; border-collapse:collapse; margin-bottom: 15px">
        <tr>
            <td style="width: 125px">Nama</td>
            <td style="width: 10px">:</td>
            <td><b><span class="nama"></span></b><td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 10px" valign="top">:</td>
            <td><b><span class="no_hp"></span></b><td>
        </tr>
        <tr>
            <td style="width: 125px" valign="top">Nama Bank</td>
            <td style="width: 10px" valign="top">:</td>
            <td><b><span class="nama_bank"></span></b><td>
        </tr>
        <tr>
            <td style="width: 125px" valign="top">No. Rekening</td>
            <td style="width: 10px" valign="top">:</td>
            <td><b><span class="no_rek"></span></b><td>
        </tr>
        <tr>
    ...
    <ol type="1" style="padding-left: 15px">
        ...
        <li><b>PIHAK KEDUA</b> tidak memiliki akad perjanjian / tidak terikat dengan Agency Property manapun sesuai dengan peraturan dari AREBI (Asosiasi Real Estate Broker Indonesia). Jika memiliki keterikatan dengan lembaga tersebut, maka wajib mengajukan surat keluar, dan dilampirkan kepada <b>PIHAK PERTAMA</b>.</li><br>
    </ol>
    ...
    <table style="width:100%; padding: 0px; border-collapse:collapse; margin-bottom: 15px">
        <tr>
            ...
            <td style="width: 10px">:</td>
            <td><b>Agen Personal PT Sharia Grup Indonesia</b><td>
        </tr>
        <tr>
            <td style="width: 125px">Masa Kontrak</td>
            <td style="width: 10px">:</td>
        ...
        <tr>
            ...
            <td style="width: 10px" valign="top">:</td>
            <td><b>Sesuai arahan dari leader dan grup</b></td>
        </tr>
    </table>
    
    <p class="center bold">Pasal 3<br>KEWAJIBAN PIHAK KEDUA</p>
    <ol type="1" style="padding-left: 15px">
        <li><b>PIHAK KEDUA</b> tidak boleh terikat dengan agency property lain yang memasarkan produk properti.</li><br>
        ...
        <li><b>PIHAK KEDUA</b> memiliki kewajiban untuk memberikan data konsumen sesuai dengan format yang telah ditentukan oleh <b>PIHAK PERTAMA</b> dan tidak diharuskan untuk mendampingi konsumennya melakukan survey lokasi (ketentuan berlaku). Data ini digunakan untuk verifikasi saat klaim komisi, dan data ini berlaku 3 bulan saja sejak pengiriman data tersebut.</li><br>
        ...
        <li><b>PIHAK KEDUA</b> tidak diperbolehkan untuk menaikan harga jual objek tanpa sepengetahuan <b>PIHAK PERTAMA</b>.</li><br>
        ...
        <li><b>PIHAK KEDUA</b> bersedia dipotong fee atau komisi untuk pajak yang diberlakukan yaitu 2.5% dari total penerimaan agen.</li><br>
        <li><b>PIHAK KEDUA</b> bersedia dipotong fee atau komisi sebesar Rp6.500,- rupiah, jika tidak menggunakan akun bank yang disarankan oleh <b>PIHAK PERTAMA</b>.</li><br>
    </ol>
    
    <p class="center bold">PASAL 4<br>KEWAJIBAN PT SHARIA GRUP INDONESIA</p>
    <ol type="1" style="padding-left: 15px">
        <li><b>PIHAK PERTAMA</b> memiliki kewajiban untuk melayani calon konsumen di kantor pemasaran atau lokasi proyek dimana kewajiban ini bisa dilakukan oleh pihak yang ditunjuk/dipercayakan.</li><br>
        <li><b>PIHAK PERTAMA</b> memilki kewajiban menyediakan tools marketing berupa data-data gambar (soft copy brosur) untuk memudahkan semua Agen dalam memasarkan.</li><br>
        <li><b>PIHAK PERTAMA</b> memiliki kewajiban memberikan Fee kepada <b>PIHAK KEDUA</b> sebagai jasa penjualan Agent tersebut diatas sesuai dengan kesepakatan kedua pihak.</li><br>
        <li>Setiap penjualan satu unit secara Kredit, Cash atau Cash bertahap, maka <b>PIHAK KEDUA</b> mendapat fee sesuai proyek yang dipasarkan (di grup dan arahan dari leader).</li><br>
        <li>Setiap pembayaran dari konsumen, akan diterima oleh <b>PIHAK DEVELOPER atau yang dipercayakan/ditunjuk oleh PIHAK PERTAMA</b>. <b>PIHAK KEDUA</b> berkewajiban untuk mengingatkan pembayaran kepada konsumen sampai dengan pembayaran DP Lunas (konsumen yang kredit) dan pembayaran lunas (konsumen yang cash keras dan bertahap).</li><br>
        <li><b>PIHAK PERTAMA</b> memiliki kewajiban memberikan informasi terkait program Pemasaran seperti Promo dan Diskon.</li><br>
    </ol>
    ...
    <ol type="1" style="padding-left: 15px">
        ...
        <li>Apabila pembatalan konsumen terjadi saat cicilan DP, maka terjadi pemotongan oleh <b>PIHAK PERTAMA</b> kepada buyer sesuai dengan akad yang berlaku pada setiap proyek.</li><br>
    ...
    <ol type="1" style="padding-left: 15px">
        ...
        <li>Apabila terjadi perselisihan antara sesama Agen terkait dengan penjualan maka akan dilakukan musyawarah yang akan dimediasi oleh <b>PIHAK PERTAMA</b>.</li><br>
    ...
    <input type="checkbox" name="setuju" id="setuju" class="me-1 form-4"><label for="setuju">Dengan ini setuju</label>
</body></html>                    