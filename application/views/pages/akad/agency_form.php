...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <p>Pada hari ini, <?= $hari?> tanggal <?= $tgl?>, dibuat dan ditandatangani perjanjian kerjasama berupa <b>SYIRKAH ABDAN</b>, oleh dan antara :</p>
    ...
    <table style="width:100%; padding: 0px; border-collapse:collapse; margin-bottom: 15px">
        <tr>
            <td style="width: 125px">Nama</td>
            <td style="width: 10px">:</td>
            <td><b><span class="nama_pemilik"></span></b><td>
        </tr>
        <tr>
    ...
    <ol type="1">
        ...
        <li>Objek kerjasama ini adalah usaha Agency Pemasaran Properti Syariah pada badan usaha <b><span class="nama_agency"></span></b>.</li>
    ...
    <ol type="1" style="padding-left: 15px">
        <li>Usaha Syirkah Abdan ini adalah usaha Agency Pemasaran Properti Syariah pada badan usaha <b><span class="nama_agency"></span></b>.</li><br>
    ...
    <ul style="padding-left: 15px">
        ...
        <ol type="1" style="padding-left: 20px">
            ...
            <li>Pihak Kedua berkewajiban mendampingi calon konsumen dalam melakukan survei lokasi dengan catatan bisa melakukan ataupun memungkinkan untuk mendampingi calon konsumen tersebut.</li><br>
    ...
    <ol type="1" style="padding-left: 15px">
        <li>Rekening Pihak Kedua untuk kebutuhan pembayaran pembagian keuntungan dari Pihak Pertama adalah sebagai berikut :<br><br>
            <table width=100%>
                ...
                <tr>
                    <td>Cabang Bank</td>
                    <td>: <b><span class="cabang_bank"></span></b></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>: <b><span class="an_rek"></span></b></td>
                </tr>
            </table>
        </li><br>
