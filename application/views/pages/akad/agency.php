...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <?php if($doc != "") :?>
        <p class="center bold"><span class="fo-16">NO. DOK : <?= $doc?></span></p>
    <?php endif;?>
    ...
    <ol type="1">
        ...
        <li>Objek kerjasama ini adalah usaha Agency Pemasaran Properti Syariah pada badan usaha <b><?=$nama_agency?></b>.</li>
    ...
    <ol type="1" style="padding-left: 15px">
        <li>Usaha Syirkah Abdan ini adalah usaha Agency Pemasaran Properti Syariah pada badan usaha <b><?=$nama_agency?></b>.</li><br>
    ...
    <ul style="padding-left: 15px">
        ...
        <ol type="1" style="padding-left: 20px">
            ...
            <li>Para Pihak berkewajiban menjualkan proyek Sharia Land secara bersama-sama dalam kurun waktu <?= $waktu?> tahun.</li><br>
        </ol>
    </ul>
    ...
    <p>Ditetapkan tanggal : <?= $tgl?></p><br><br>
